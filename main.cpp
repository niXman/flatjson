...
static void unit_21_get_keys_cb(void *userdata, const char *ptr, std::size_t len) {
...
static void unit_21() {
    ...
    int num = flatjson::fj_get_keys(toksbeg, toksend - toksbeg, &calls_cnt, &unit_21_get_keys_cb);
    assert(num == 2);
    assert(calls_cnt == 2);
